...
def render_stock_overview(stock_data: pd.DataFrame, pca_row: pd.Series):
    ...
    with col1:
        st.metric(
            ...
            f"{pc1:.3f}",
            delta=("↑ " if pc1 >= 0 else "↓ ") + (PC1_INTERPRETATION['high_meaning_shorthand'] if pc1 >= 0 else PC1_INTERPRETATION['low_meaning_shorthand']),
    ...
    with col2:
        st.metric(
            ...
            f"{pc2:.3f}",
            delta=("↑ " if pc2 >= 0 else "↓ ") + (PC2_INTERPRETATION['high_meaning_shorthand'] if pc2 >= 0 else PC2_INTERPRETATION['low_meaning_shorthand']),
            delta_color="off"
        )
